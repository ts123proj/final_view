			...
			<div class="row">
				...
				<div class="col-xl-4 col-lg-6 col-md-6">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt liked"></a>
							<a href="tour-detail.jsp"><img src="img/tour_5.jpg" class="img-fluid" alt="" width="800" height="533"></a>
							<small>Walking</small>
							<div class="read_more"><span>Read more</span></div>
						</figure>
						<div class="wrapper">
				...
				<div class="col-xl-4 col-lg-6 col-md-6">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt liked"></a>
							<a href="tour-detail.jsp"><img src="img/tour_6.jpg" class="img-fluid" alt="" width="800" height="533"></a>
							<small>Museum</small>
							<div class="read_more"><span>Read more</span></div>
						</figure>
						<div class="wrapper">
